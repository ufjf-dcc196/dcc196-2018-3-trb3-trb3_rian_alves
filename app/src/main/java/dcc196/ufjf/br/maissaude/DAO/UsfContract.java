...
public class UsfContract {
    public final class USF implements BaseColumns {
        ...
        public static final String COLUMN_NAME_CEP = "temporada";
        public static final String COLUMN_NAME_FOTO = "episodio";
    ...
    public final class Area implements BaseColumns {
        ...
        public static final String COLUMN_NAME_CEP_USF = "cepUSF";
